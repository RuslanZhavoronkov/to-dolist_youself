...
import { AppForReducerActionsType, appReducer } from './app-reducer';
...
export type AppRootActionsType = TodolistActionsType | TaskActionsType |  AppForReducerActionsType
