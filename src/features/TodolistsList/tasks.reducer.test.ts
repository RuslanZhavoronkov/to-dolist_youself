...
import { tasksReducer, TasksStateType, taskThunks } from "features/TodolistsList/tasks.reducer"
...
test("correct task should be deleted from correct array", () => {
  ...
  const action = taskThunks.removeTaskTC.fulfilled(
    payload,
    "requestId",
    payload
  )
...
test("new array should be added when new todolist is added", () => {
  ...
  const action = todolistThunks.addTodolist.fulfilled(payload, 'requestId', payload.todolist.title)
  const endState = tasksReducer(startState, action)
