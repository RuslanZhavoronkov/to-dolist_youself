...
import { LoginStateType } from '../features/Login/login-reducer';
...
export const authAPI = {
    ...
    authMe() {
        return instance.get<ResponseType<ResponseGetAuthDataType>>(`auth/me`)
    }
}
...
export type ResponseGetAuthDataType = {
    id: number,
    login: string,
    email: string
}
